...
// Removed: Continuous CSS carousels function best without manual JS swipe interference on mobile. 
// The CSS `animation: carousel-scroll` handles the infinite loop natively and smoothly.
